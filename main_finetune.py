...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='./finetuning_output_dir',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./finetuning_output_dir',
...
def main(args):
    ...
    if args.finetune and not args.eval:
        ...
        if 'model' in checkpoint:
            ...
            assert 'No state_dict in checkpoint'
